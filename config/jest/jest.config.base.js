...
function buildPackageJsProjects(package) {
  return [buildUnitPackageJsProject(package), buildIntegrationPackageJsProject(package)];
}
...
function buildPackageTsProjects(package) {
  return [buildUnitPackageTsProject(package), buildIntegrationPackageTsProject(package)];
}
